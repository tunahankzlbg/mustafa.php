...
<body class="h-[100vh] bg-slate-200">
    ...
    while ($goster = mysqli_fetch_array($cek)) {
        ...
        echo "<div class = 'flex flex-col bg-white w-100 h-auto m-12 p-4'>" . "<div> <strong>ID: </strong> "  . $id . "</div>" . "<div> <strong>Ad ve soyad: </strong> "  . $adsoyad . "</div>" . "<br/>" .
            ...
            "<div class = 'w-full'> <strong>Şifre: </strong> "  . "<input type='password' disabled value ='$sifre' id = 'pass'>" . "</input>" . "<input type='checkbox' onclick='passw()'> Şifreyi göster" . " <br/>  <a href='duzenle.php?id='63' class='font-bold text-red-500 inline-block mt-4'> Düzenle </a>  </div>" . "<br/>" .
            "</div>";
    }
    ?>
